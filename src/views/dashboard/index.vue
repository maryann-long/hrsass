<template>
  <div class="dashboard-container">
    ...
    <el-row type="flex" justify="space-between">
      ...
      <el-col :span="11">
        <el-card class="box-card">
          ...
          <div class="sideNav">
            <el-button class="sideBtn" @click="btnExcept">加班离职</el-button>
    ...
    <el-dialog :visible="showDialog" title="离职请假" @close="btnCancel">
      <!-- 是否在输入框中显示校验结果反馈图标	 -->
      <el-form ref="ruleForm" label-width="120px" :model="ruleForm" :rules="rules" status-icon>
        <el-form-item label="期望离职时间" prop="exceptTime">
          <el-date-picker v-model="ruleForm.exceptTime" type="datetime" value-format="yyyy-MM-dd HH:mm:ss" placeholder="请选择时间" />
        </el-form-item>
        <el-form-item label="离开原因" prop="reason">
          <el-input
            type="textarea"
